...
class Student(BaseUser):
    ...
    school = models.ForeignKey('department', null=True, blank=True, verbose_name="学校",db_index=True,on_delete=models.CASCADE,related_name="school")
    campus = models.ForeignKey('department', null=True, blank=True, verbose_name="校区",db_index=True,on_delete=models.CASCADE,related_name="campus")
    grade = models.ForeignKey('department', null=True, blank=True, verbose_name="年级",db_index=True,on_delete=models.CASCADE,related_name="grade")
    study_class = models.ForeignKey('department', null=True, blank=True, verbose_name="班级",db_index=True,on_delete=models.CASCADE,related_name="study_class")
...
class Teacher(BaseUser):
    ...
    name = models.CharField(max_length=30, verbose_name="姓名")
    sex = models.CharField(max_length=30, null=True, verbose_name="性别", blank=True)
    school = models.ForeignKey('department', null=True, blank=True, verbose_name="学校",db_index=True,on_delete=models.CASCADE,related_name="teach_school")
    campus = models.ForeignKey('department', null=True, blank=True, verbose_name="校区",db_index=True,on_delete=models.CASCADE,related_name="teach_campus")
    grade = models.ForeignKey('department', null=True, blank=True, verbose_name="年级",db_index=True,on_delete=models.CASCADE,related_name="teach_grade")
    manage_class = models.ForeignKey('department', null=True, blank=True, verbose_name="班级",db_index=True,on_delete=models.CASCADE,related_name="manage_class")
    province = models.CharField(max_length=30, null=True, blank=True, verbose_name="省份")
    city = models.CharField(max_length=30, null=True, blank=True, verbose_name="城市")
    district = models.CharField(max_length=30, null=True, blank=True, verbose_name="地区")
    created_at = models.DateTimeField(default=timezone.now, verbose_name='创建时间',db_index=True)
...
class Course(models.Model):
    ...
    teach_class = models.ForeignKey('department', verbose_name="授课班级",db_index=True,on_delete=models.CASCADE ,related_name="teach_class")
